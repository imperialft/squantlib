...
package net.squantlib.util.ql.math;

import net.squantlib.util.ql.lang.annotation.NonNegative;
...
final public class Closeness {
  ...
  static public final boolean isClose(
    final double x,
    final double y
  ) {
  ...
  static public final boolean isCloseEnough(
    final double x,
    final double y
  ) {
