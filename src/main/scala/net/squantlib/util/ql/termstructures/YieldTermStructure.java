...
import net.squantlib.util.ql.time.Frequency;
...
public abstract interface YieldTermStructure extends TermStructure {
   ...
   * net.squantlib.util.ql.termstructures.InterestRate.Compounding, Frequency)
   */
  public abstract InterestRate forwardRate(
   ...
   *
   * @category discount factors
   * @see net.squantlib.util.ql.termstructures.YieldTermStructureImpl#discount(net.squantlib.util.ql.time.Date, boolean)
   */
  public abstract/* @DiscountFactor */double discount(
    final Date d,
    boolean extrapolate
  );
   ...
   *
   * @category discount factors
   * @see net.squantlib.util.ql.termstructures.YieldTermStructureImpl#discount(double, boolean)
   */
  public abstract/* @DiscountFactor */double discount(
    final/* @Time */double t,
    boolean extrapolate
   ...
   */
  public abstract/* @Rate */double parRate(
    int tenor,
