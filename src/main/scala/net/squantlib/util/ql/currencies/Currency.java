...
public class Currency implements Cloneable {
  ...
  public static final boolean operatorEquals(
    final Currency c1,
    final Currency c2
  ) {
    return c1.equals(c2);
  ...
  public static final boolean operatorNotEquals(
    final Currency c1,
    final Currency c2
  ) {
    // eating our own dogfood
  ...
  protected static class Data implements Cloneable {
     ...
     * @param rounding         The rounding scheme used for this currency net.squantlib.util.ql.math.Rounding
