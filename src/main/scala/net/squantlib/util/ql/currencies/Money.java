...
public class Money implements Cloneable {
  ...
  public Money(
    final Currency currency, /* @Decimal */
    final double value
  ) {
    QL.validateExperimentalMode();
    this.value_ = (value);
  ...
  public Money(/* @Decimal */final double value,
  ...
  // FIXME: suspicious....
  public Money operatorMultiply(/* Decimal */final double value,
                                             final Currency c
  ) {
    return new Money(value, c);
  }

  public static Money multiple(
    final Currency c, /* Decimal */
    final double value
  ) {
    return new Money(value, c);
  }

  public static Money multiple( /* Decimal */final double value,
                                             final Currency c
  ) {
    return new Money(value, c);
  }
