...
import net.squantlib.util.ql.math.Closeness;
import net.squantlib.util.ql.math.interpolations.DefaultExtrapolator;
...
public abstract class AbstractTermStructure implements TermStructure {
    ...
    protected void checkRange(final Date d, final boolean extrapolate) /* @ReadOnly */ {
        ...
        QL.require(extrapolate || allowsExtrapolation() || d.le(maxDate()) , "date is past max curve (" + d.shortDate().toString() + " > " + maxDate().shortDate().toString() + ")"); // TODO: message
    }
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#calendar()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#settlementDays()
     */
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#timeFromReference(net.squantlib.util.ql.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#dayCounter()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#maxTime()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.squantlib.util.ql.termstructures.TermStructure#referenceDate()
     */
    @Override
