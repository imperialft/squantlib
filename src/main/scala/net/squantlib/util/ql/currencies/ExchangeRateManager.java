...
package net.squantlib.util.ql.currencies;

import net.squantlib.util.ql.QL;
import net.squantlib.util.ql.currencies.America.PEHCurrency;
import net.squantlib.util.ql.currencies.America.PEICurrency;
import net.squantlib.util.ql.currencies.America.PENCurrency;
import net.squantlib.util.ql.currencies.Europe.*;
import net.squantlib.util.ql.lang.exceptions.LibraryException;
import net.squantlib.util.ql.lang.iterators.Iterables;
...
//        }
   ...
   * @return
   */
  public boolean hashes(/* ExchangeRateManager::Key */final int k,
                                                      final Currency c
  ) {
   ...
   */
  private ExchangeRate directLookup(
    final Currency source,
    final Currency target,
    final Date date
  ) {
   ...
   */
  private int matchValidateAt(
    final List<Entry> rates,
    final Date date
  ) {
