...
public class ZeroCouponBond extends Bond {
	...
	public ZeroCouponBond(
            ...
            final String creditSpreadID,
            final Double initialFX) {
		this(settlementDays, calendar, faceAmount, maturityDate, BusinessDayConvention.Following, 100.0, new Date(), id, currency, creditSpreadID, initialFX);
	}
	...
	public ZeroCouponBond(
            ...
            final String creditSpreadID,
            final Double initialFX) {
		this(settlementDays, calendar, faceAmount, maturityDate, paymentConvention, redemption, new Date(), id, currency, creditSpreadID, initialFX);
	}
	...
	public ZeroCouponBond(
            ...
            final String creditSpreadID,
            final Double initialFX) {
		this(settlementDays, calendar, faceAmount, maturityDate, paymentConvention, 100.0, new Date(), id, currency, creditSpreadID, initialFX);
	}
}
