...
//  
//	assert (scheduledPayoffs.payoffs.variables.size == 1, "assertion failed : variables=" + scheduledPayoffs.payoffs.variables.size)
//	
...
//	    return None}
//	  
//	  Some(IndexMontecarlo1f(valuedate, mcmodel, scheduledPayoffs, index, paths, triggers))
//	}
//}
//
//
