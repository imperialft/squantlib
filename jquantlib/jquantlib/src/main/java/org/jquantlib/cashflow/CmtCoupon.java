 ...
 */
public class CmtCoupon extends FloatingRateCoupon {

    protected BondYieldIndex bondYieldIndex_;

    public CmtCoupon(final Date paymentDate,
    ...
    public BondYieldIndex bondYieldIndex() {
        return bondYieldIndex_;
    }
    ...
    public void accept(final PolymorphicVisitor pv) {
        final Visitor<CmtCoupon> v = (pv!=null) ? pv.visitor(this.getClass()) : null;
        if (v != null) {
            v.visit(this);
        } else {
            super.accept(pv);
